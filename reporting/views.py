...
from reporting.models import MonthlyRecord
...
class MonthlyListView(ListView):
    ...
    template_name = 'reporting/records_list.html'
...
class CreateMonthlyView(CreateView):
    ...
    model = MonthlyRecord
    fields = ['vehicle', 'year', 'month', 'fuel_consumed', 'cost', 'km']
    template_name = 'reporting/add_monthly.html'
...
class CreateMonthlyViewCar(LoginRequiredMixin, CreateView):
    ...
    model = MonthlyRecord
    fields = ['vehicle', 'year', 'month', 'fuel_consumed', 'cost', 'km']
    template_name = 'reporting/edit_monthly.html'
...
class MonthlyView(DetailView):
    ...
    model = MonthlyRecord
    template_name = 'reporting/monthly.html'
